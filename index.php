		...
		<div class="navbar navbar-inverse navbar-fixed-top" role="banner"> 
			<div class="container"> 
				<div class="navbar-header"> 
					...
					<a class="navbar-brand" href="<?php echo $this->baseurl;?>"><h1><img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/summit_logo.gif" alt="logo"></h1></a> 
				</div> 
	...
	<section id="portfolio">
		...
		<section id="contact">
			<div class="container">
				...
				<div class="col-md-6">
					<h2 class="contact-heading">Follow Us</h2>
				...
				<div class="col-md-6">
					<h2 class="contact-heading">Suggestions</h2>
